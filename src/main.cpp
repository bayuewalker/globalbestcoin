...
uint256 hashGenesisBlock("0xc76d13adb69b590be97c03cc643d643e26b409fe747ab3dea7a358d7cec5bf90");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 170000); // Globalbestcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Globalbestcoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Globalbestcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd9c77abbc167cfdf39e75930d6904f1d7b416b3fdbe6bbdffcf5a9248a6f929b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1536403076;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086032981;

        if (fTestNet)
        {
            block.nTime    = 1536403087;
            block.nNonce   = 387896166;
        }
	...
	if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x714c5249b369b6cea9afe5d97b26b40212096c6ff238aeb43f376857970b3b1d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc2, 0xb1, 0xdb }; // Globalbestcoin: increase each by adding 2 to bitcoin's value.
